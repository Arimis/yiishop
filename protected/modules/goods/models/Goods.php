...
class Goods extends BaseModel
{
	...
	public function rules()
	{
        ...
        return array(
            ...
            array('goods_id, bn, name, type_id, cat_id, brand_id, store, price, cost, mktprice, weight, unit, goods_type, image_default_id, brief, intro, goods_setting, is_spec, spec_desc, params, marketable, p_order, create_time, update_time, disabled', 'safe', 'on'=>'search'),
        );
	}
